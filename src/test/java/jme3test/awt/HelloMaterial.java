...
public class HelloMaterial extends SimpleApplication {
	...
	public void simpleUpdate(float tpf) {
		...
		tpf *= 0.1f;
		cube1Geo.rotate(tpf, tpf, tpf);
		cube2Geo.rotate(0, 0, tpf);
	...
	public void simpleInitApp() {
		...
		TangentBinormalGenerator.generate(cube1Mesh);
		Material cube1Mat = new Material(assetManager, "Common/MatDefs/Light/Lighting.j3md");
		Texture cube1Tex = assetManager.loadTexture("G6n.png");
		cube1Mat.setTexture("DiffuseMap", cube1Tex);
		cube1Mat.setTexture("NormalMap", assetManager.loadTexture("G6n_n.jpg"));
